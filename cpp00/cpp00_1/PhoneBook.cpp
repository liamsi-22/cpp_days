...
void PhoneBook::addContact(){
    ...
    contacts[index++ % 8].setContact(fn, ln, nick, num, dsc);
}
...
void PhoneBook::searchContact(){
    ...
    while (i < 8 && !contacts[i].CtcisEmpty())
    {
    ...
    std::cin >> x;
    if (std::cin.fail() || x < 0 || x > 7 || contacts[x].CtcisEmpty())
    {
        std::cin.clear();
        // check this line
